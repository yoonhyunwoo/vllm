...
change the import to: from vllm.watermark import ...
...
_WATERMARK_PATH = os.path.join(
    os.path.dirname(__file__), "..", "vllm", "watermark.py"
)
_spec = importlib.util.spec_from_file_location(
    "vllm.watermark", os.path.abspath(_WATERMARK_PATH)
)
wm = importlib.util.module_from_spec(_spec)
sys.modules["vllm.watermark"] = wm
